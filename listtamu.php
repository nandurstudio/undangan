						...
						<div class="row animate-box">
							...
							if ($result = mysqli_query($conn, $sql)) {
								if (mysqli_num_rows($result) > 0) {
									...
									echo "<th onclick=\"sortTable(2)\">Address</th>";
									echo "<th onclick=\"sortTable(3)\">Attending</th>";
									echo "<th onclick=\"sortTable(4)\">Guests</th>";
									echo "<th onclick=\"sortTable(5)\">Session</th>";
