								...
								<div class="card">
									<div class="card-body">
										<div class="profile-blog">
											...
											<h4><a href="post-details.php" class="text-black">Darwin Creative Agency Theme</a></h4>
									...
									<div class="card-body">
										<div class="profile-interest">
											...
											<div class="row mt-4 sp4" id="lightgallery">
												<a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg" data-src="assets/images/profile/2.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="assets/images/profile/2.jpg" alt="" class="img-fluid">
												</a>
												<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="assets/images/profile/3.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="assets/images/profile/3.jpg" alt="" class="img-fluid">
												</a>
												<a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg" data-src="assets/images/profile/4.jpg" class="lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
										...
										<div class="profile-news">
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.php" class="text-black">Empower your project management.</a></h5>
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.php" class="text-black">Streamline project oversight and control.</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.php" class="text-black">Collection of textile samples</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
										</div>
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<div class="input-group mb-3">
																			...
																			<div class="form-file rounded-end">
																				<input type="file" class="form-file-input form-control rounded-end">
																			</div>
																		</div>
																	</div>
																</div>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="assets/images/profile/8.jpg" alt="" class="img-fluid w-100 rounded">
														<a class="post-title" href="post-details.php"><h3 class="text-black">Elevate your project management efficiency</h3></a>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="assets/images/profile/9.jpg" alt="" class="img-fluid w-100 rounded">
														<a class="post-title" href="post-details.php"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
                                                                    class="fa fa-heart"></i></span>Like</button>
                                                    ...
                                                    <div class="profile-uoloaded-post pb-3">
                                                        <img src="assets/images/profile/8.jpg" alt="" class="img-fluid w-100 rounded">
														<a class="post-title" href="post-details.php"><h3 class="text-black">Unlock the full potential of your projects.</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
                                                                    class="fa fa-heart"></i></span>Like</button>
