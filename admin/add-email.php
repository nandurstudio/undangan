									...
									<div class="row">
											...
											<form>
											  <div class="mb-3">
												...
												<input type="text" class="form-control">
												 <div class="form-text">Title should be meaning full like : registration email, forgot password email.</div>
											  </div>
											  <div class="mb-3">
										...
										<div class="col-xl-6">
											<div class="mb-3">
												...
												<input class="form-control bg-light" type="text" placeholder="Slug" aria-label="Disabled input example" disabled>
										...
										<div class="col-xl-12">
											...
											<div class="form-text mb-3">This design will show in recieved email and place holders will replace with dynamic content.</div>
										</div>
										<label class="form-label">Status</label>
										<ul class="d-flex align-items-center mb-3">
											<li><div class="form-check mb-2"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"> <label class="form-check-label" for="flexCheckDefault"></label></div></li>
