				...
				<div class="row">
					...
					<div class="col-md-8 col-md-offset-2 js animate__animated">
						<form class="form-group">
							<?php
							include "./php/connection.php";
							// COUNT distinct reservasi and return latest date (ONLY_FULL_GROUP_BY safe)
							$guest_query = "SELECT COUNT(DISTINCT namareservasi) AS namareservasi, MAX(`date`) AS last_date FROM tr_ucapan;";
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center">
						...
						<br />
						<div class="col-md-8 col-md-offset-2 text-center">
							<a class="demo js animate__animated" href="images/rat/events.png?v=<?php echo filemtime('./images/rat/events.png'); ?>" data-lightbox="example-1">
								<img src="images/rat/events.png?v=<?php echo filemtime('./images/rat/events.png'); ?>" alt="Event" class="img-responsive foto-pengantin js animate__animated">
							</a>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center">
						...
						<div id="map" class="fh5co-map event-wrap">
							<div class="col-md-8 col-md-offset-2 text-center">
								<p class="js animate__animated"><span style="font-weight:bold;">MNF Cikampek - KNLC LT. 3</span><br />PT. Sanghiang Perkasa - Kalbe Nutritionals,<br />Kawasan Industri Indotaisei, Kalihurip, Kec. Cikampek,<br />Karawang, Jawa Barat 41373</p>
								...
								<img src="images/denaya/separator.png?v=<?php echo filemtime("./images/denaya/separator.png"); ?>" alt="denaya_separator" class="img-responsive flower denaya-separator js animate__animated">
							</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					...
					<div id="map" class="fh5co-map event-wrap">
						<div class="col-md-8 col-md-offset-2 text-center">
							<p class="js animate__animated"><span style="font-weight:bold;">IDC Cakung - Proximity Room</span><br />Innovation and Development Center PT. Sanghiang Perkasa,<br />Jl. Raya Bekasi Km 25, Cakung Tim.,<br />Kec. Cakung, Kota Jakarta Timur,<br />Daerah Khusus Ibukota Jakarta 13910</p>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center">
						...
						<div class="col-md-8 col-md-offset-2 text-center kolom">
							<div class="text-center">
								<img src="images/rat/tumbler.png?v=<?php echo filemtime('./images/rat/tumbler.png'); ?>" alt="Botol tumbler" class="img-responsive logo-qrcode js animate__animated">
								<div class="p-protokol js animate__animated">Wajib membawa Tumbler untuk yang sedang tidak berpuasa</div>
							</div>
							<div class="text-center">
								<img src="images/rat/team.png?v=<?php echo filemtime('./images/rat/team.png'); ?>" alt="Gunakan Jas" class="img-responsive logo-qrcode js animate__animated">
								<div class="p-protokol js animate__animated">Gunakan Dresscode sesuai ketentuan berupa Monokrom (hitam-putih)</div>
							</div>
						</div>
						<div class="col-md-8 col-md-offset-2 text-center kolom">
							<div class="text-center">
								<img src="images/rat/voucher.png?v=<?php echo filemtime('./images/rat/voucher.png'); ?>" alt="Tiket" class="img-responsive logo-qrcode js animate__animated">
								<div class="p-protokol js animate__animated">Siapkan tiket virtual ini sebagai akses masuk</div>
							</div>
							<div class="text-center">
								<img src="images/rat/qr-scan.png?v=<?php echo filemtime('./images/rat/qr-scan.png'); ?>" alt="Scan QR Code" class="img-responsive logo-qrcode logo-jaga-jarak js animate__animated">
								<div class="p-protokol js animate__animated">Tunjukan QR Code saat melakukan registrasi</div>
							</div>
						</div>
						<div class="col-md-8 col-md-offset-2 text-center">
							<img src="images/rat/gadget.png?v=<?php echo filemtime('./images/rat/gadget.png'); ?>" alt="No Laptop" class="img-responsive logo-qrcode logo-jaga-jarak js animate__animated">
